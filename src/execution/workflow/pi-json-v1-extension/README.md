...
TypeScript checking against Pi 0.85.0 and its bundled TypeBox 1.3.7, generated-fixture
...
exact Pi 0.85.0 extension and provider APIs. That provider communicates only through
