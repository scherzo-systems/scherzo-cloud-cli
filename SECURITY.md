...
`2.1.260`; accepting the range does not claim exact-binary conformance for every release
...
the ephemeral-thread contract. The exact repository qualification anchor is `0.153.4`;
