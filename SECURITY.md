...
`>=0.147.0 <0.157.0`, and require the maintained App Server schema capability, including
the ephemeral-thread contract. The exact repository qualification anchor is `0.156.1`;
