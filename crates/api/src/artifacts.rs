...
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct ArtifactInventoryPage {
...
pub struct ArtifactCapabilityMember {
    pub member: ArtifactMember,
    pub url: String,
}
...
pub struct ArtifactCapabilities {
    ...
    pub members: Vec<ArtifactCapabilityMember>,
}
