...
pub type RunnerDeletionBlocker = models::ProblemBlocker;

#[derive(Clone, Copy)]
pub enum RunnerRegistrationMode {
    Enabled,
    Draining,
    Disabled,
}
...
impl RunnerApi {
    ...
    pub fn update_registration_mode(
        &self,
        organization: &str,
        runner_ref: &str,
        idempotency_key: &str,
...
#[allow(
    ...
    clippy::expect_used,
    clippy::unwrap_used,
    reason = "runner API unit tests use Rust test assertions and fixture extraction"
)]
mod tests;
