...
#[derive(Clone, Copy)]
pub(in crate::workflow) enum BundleMutation {
    InvalidHeader,
    MismatchedProfile,
    TruncatedPack,
    BadChecksum,
...
pub(in crate::workflow) struct RealBundleFixture {
...
impl RealBundleFixture {
    ...
    pub(in crate::workflow) fn failure(&self, mutation: BundleMutation) -> GitArtifactFailure {
