...
#[derive(Clone)]
pub struct CloudGitCaptureProjection {
...
impl GitCaptureContext {
    ...
    pub fn carrier_limits(&self) -> (usize, u64, u64) {
        self.carrier_limits
    }
