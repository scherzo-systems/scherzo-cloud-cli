...
use crate::workflow::artifact::{CaptureBoundary, CaptureBoundaryObserver, CarrierBudgetClass};
use crate::workflow::git_artifact::{
...
fn admitted_capture<const N: usize>(
    ...
    crate::workflow::admission::AdmittedWorkflow,
    ArtifactStaging,
) {
