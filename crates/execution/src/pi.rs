...
impl ValidatedPiInstallation {
    ...
    pub const fn version(&self) -> &PiVersion {
        &self.version
    }
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub enum PiInstallationFailure {
    Missing,
    Unexecutable {
...
pub fn discover_and_validate_pi_installation()
