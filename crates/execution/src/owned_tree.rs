...
pub fn open_directory_at(parent: &OwnedFd, identity: &str) -> Result<OwnedFd, Errno> {
...
pub fn open_regular_file_at(parent: &OwnedFd, identity: &str) -> Result<(OwnedFd, Stat), Errno> {
